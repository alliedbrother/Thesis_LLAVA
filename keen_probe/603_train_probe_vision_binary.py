...
CONFIG = {
    ...
    "MODEL_SAVE_DIR": "/root/projects/Thesis_LLAVA/keen_probe/keen_data/models_binary",
    "LOG_DIR": "/root/projects/Thesis_LLAVA/keen_probe/keen_data/logs_binary",
    
    # Model parameters
    "REQ_EMBEDDINGS": "vision_embeddings",
    "INPUT_DIM": 1024,        # Length of input embeddings
