...
CONFIG = {
    ...
    "MODEL_DIR": "/root/projects/Thesis_LLAVA/keen_probe/keen_data/models_binary",
    "RESULTS_DIR": "/root/projects/Thesis_LLAVA/keen_probe/keen_data/results_binary",
                    ...
                    if image_group in split_ids:
                        try:
                            ...
                            if emb.ndim != 1 or emb.shape[0] != CONFIG["INPUT_DIM"]:
                                print(f"Warning: Unexpected embedding shape {emb.shape} for {image_group}, skipping.")
                                continue
