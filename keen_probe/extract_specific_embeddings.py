...
def extract_embeddings():
    ...
    output_path = "/home/luk_lab/Desktop/Luk Lab - AI/projects/thesis/Thesis_LLAVA/keen_probe/keen_data/specific_embeddings.json"
    ...
    try:
        with h5py.File(h5_path, 'r') as f:
            ...
            step_0 = steps_group.get('step_0')
            if step_0 is None:
                print("\nError: step_0 not found")
                return
            
            print("\nStructure of step_0:")
            print("-" * 50)
            print_group_structure(step_0)
            
            # Extract sequence embeddings for layers 0, 1, 16, 31, 32
            seq_emb_group = step_0.get('sequence_embeddings')
            ...
            vision_query_group = step_0.get('vision_query_embeddings')
